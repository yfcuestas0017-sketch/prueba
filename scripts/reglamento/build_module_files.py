...
# Paso 2 de 2 del pipeline de extraccion del reglamento. Ver README.md.
# CUIDADO: sobrescribe backend/chatbook/regulation/regulation_data.js, que
# esta en uso. El destino original ('server/') ya no existe.

SCRIPT_DIR = Path(__file__).resolve().parent
REPO_ROOT = SCRIPT_DIR.parent.parent

with open(SCRIPT_DIR / 'reglamento_structured.json', 'r', encoding='utf-8') as f:
    data = json.load(f)

# Ensure target directory exists
target_dir = os.path.join(REPO_ROOT, 'backend', 'chatbook', 'regulation')
